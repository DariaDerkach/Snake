'''Игра змейкабуправление -стрелками на клавиатуре'''
import random
from tkinter import *
...
class Food:
    def __init__(self):
        x = random.randint(0, (WINDOW_WIDTH/SPACE_SIZE) -
                           1) * SPACE_SIZE   # 1200/25 = 48
        y = random.randint(0, (WINDOW_HEIGHT/SPACE_SIZE) -
                           1) * SPACE_SIZE   # 800/25 = 32
